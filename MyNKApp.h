...
protected:
	...
	D3DXVECTOR3			m_vMouseDrag1, m_vMouseDrag2;	//ulyssesme-20060928 : �巡�� ��������
	D3DXVECTOR3			m_vMouseDrag3, m_vMouseDrag4;	//ulyssesme-20060928 : �巡�� ������
	...
	BOOL				m_bShowAttr_Map;				// nate 2006-01-12 : �Ӽ��� ���̱�
	...
	BOOL				m_bShowLocalAxis;               // ������Ʈ�� �׽ý��� �����ٶ� ��������� ���������� ���� üũ ����.
...
public:
	...
	void	RotateSelDecoObjsByPivot( float fdDeg, D3DVECTOR Pivot ); // Ư����ǥ�� �������� ȸ�������ִ� �Լ�. 06-09-12 ���� (Y�� ����)
	...
	float m_fCameraSpeed; // ī�޶� ���ǵ� ���� ��� Ȯ��(by ����)
	float m_bCameraUnlimit; // ī�޶� �þ������� ���ִ� üũ ���. ///071022 �߰�

	CMyNKApp();
	~CMyNKApp();
	LRESULT	MsgProc( UINT uMsg, WPARAM wParam, LPARAM lParam );
	
	// [10/26/2007 Theodoric] Undo�� ���� �߰� �Լ�
